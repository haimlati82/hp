...
function hp_setup() {
	 ...
	 * If you're building a theme based on hp, use a find and replace
...
/*    function admin_in_english_add_hooks() {
        ...
        echo '<pre>';
        print_r(admin_in_english_is_tiny_mce());
        echo '</pre>';
        if($template_name === 'page-product.php'){
            add_filter( 'locale', 'admin_in_english_locale' );

        }

    }
    add_action( 'init', 'admin_in_english_add_hooks' );
    ...
    include_once('inc/wp-cuztom-master/cuztom.php');
    include_once('inc/ajax_func.php');
    include_once('inc/theme-func.php');
    include_once('inc/front_end-function.php');
    include_once('inc/ninja_cu.php');
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'hp' ),
	) );
